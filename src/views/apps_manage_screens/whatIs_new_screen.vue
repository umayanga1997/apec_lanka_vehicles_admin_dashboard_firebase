      ...
      <v-row justify="center">
        <v-dialog v-model="dialog" max-width="600px">
          <ValidationObserver ref="observer" v-slot="{ invalid }">
            <v-card>
              <v-card-title fixed>
                <span class="headline">What is New Details</span>
              </v-card-title>
              <v-card-text>
                <v-container>
                  <v-row class="mt-4">
                    ...
                    <v-col cols="12" sm="12" md="12">
                      ...
                      >
                        <v-textarea
                          ...
                          hint="Enter note of new feature"
                        ></v-textarea>
                      </validation-provider>
                    </v-col>
                  </v-row>
...
const NoteFetchRef = fireStore.collectionGroup("what_is_new_configs");
const NoteRef = fireStore
  .collection("apps_management")
  .doc("FU0U4I2n3PuXmL4LWtIy")
  .collection("what_is_new_configs");
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "Note Description", value: "note", width: "300px" },
